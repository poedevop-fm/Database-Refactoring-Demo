...
--
IF    OBJECT_ID(N'testCustomerTrigger.[test that trigger handles UPDATE old with only a case difference]','P') IS NOT NULL
   DROP PROCEDURE testCustomerTrigger.[test that trigger handles UPDATE old with only a case difference];
GO
CREATE PROCEDURE  testCustomerTrigger.[test that trigger handles UPDATE old with only a case difference]
AS
BEGIN
    --Arrange
    IF OBJECT_ID('expected') IS NOT NULL DROP TABLE expected;
...
END;
GO
IF    OBJECT_ID(N'testCustomerTrigger.[test that trigger handles UPDATE new with only a case difference]','P') IS NOT NULL
   DROP PROCEDURE testCustomerTrigger.[test that trigger handles UPDATE new with only a case difference];
GO
CREATE PROCEDURE  testCustomerTrigger.[test that trigger handles UPDATE new with only a case difference]
AS
BEGIN
    --Arrange
    IF OBJECT_ID('expected') IS NOT NULL DROP TABLE expected;
...
END;
GO
IF    OBJECT_ID(N'testCustomerTrigger.[test that trigger handles INSERT old that differs only by case]','P') IS NOT NULL
   DROP PROCEDURE testCustomerTrigger.[test that trigger handles INSERT old that differs only by case];
GO
CREATE PROCEDURE  testCustomerTrigger.[test that trigger handles INSERT old that differs only by case]
AS
BEGIN
    --Arrange
    IF OBJECT_ID('expected') IS NOT NULL DROP TABLE expected;
...
--
IF    OBJECT_ID(N'testCustomerTrigger.[test that trigger handles multi-row UPDATEs to old correctly]','P') IS NOT NULL
   DROP PROCEDURE testCustomerTrigger.[test that trigger handles multi-row UPDATEs to old correctly];
GO
CREATE PROCEDURE  testCustomerTrigger.[test that trigger handles multi-row UPDATEs to old correctly]
AS
BEGIN
    --Arrange
    IF OBJECT_ID('expected') IS NOT NULL DROP TABLE expected;
...
END;
GO
IF    OBJECT_ID(N'testCustomerTrigger.[test that trigger handles multi-row UPDATEs to new correctly]','P') IS NOT NULL
   DROP PROCEDURE testCustomerTrigger.[test that trigger handles multi-row UPDATEs to new correctly];
GO
CREATE PROCEDURE  testCustomerTrigger.[test that trigger handles multi-row UPDATEs to new correctly]
AS
BEGIN
    --Arrange
    IF OBJECT_ID('expected') IS NOT NULL DROP TABLE expected;
