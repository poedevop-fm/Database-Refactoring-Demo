...
--
--
IF OBJECT_ID(N'testSplitTableTriggers.[test that trigger handles INSERT Customer using new columns]','P') IS NOT NULL
   DROP PROCEDURE testSplitTableTriggers.[test that trigger handles INSERT Customer using new columns];
GO
CREATE PROCEDURE testSplitTableTriggers.[test that trigger handles INSERT Customer using new columns]
AS
BEGIN
    --Arrange
    IF OBJECT_ID('expected_customer') IS NOT NULL DROP TABLE expected_customer;
   ...
   VALUES
   (@id, '325 S. Santa Claus Lane', '', 'North Pole', 'AK', '', '99705');
